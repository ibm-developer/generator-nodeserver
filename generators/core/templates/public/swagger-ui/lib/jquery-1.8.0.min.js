!(function(e, t) {
        ...
        try {
          r =
            ...
            ('false' !== r &&
              ('null' === r
                ? null
                : +r + '' === r ? +r : ge.test(r) ? K.parseJSON(r) : r));
        } catch (o) {}
        K.data(e, n, r);
      } else r = t;
    }
        ...
        tabIndex: {
          get: function(e) {
            ...
            return n && n.specified
              ? parseInt(n.value, 10)
              : Ne.test(e.nodeName) || (Ce.test(e.nodeName) && e.href) ? 0 : t;
          },
        },
      },
    }),
          ...
          for (
            ...
            (f = u.matches[i]),
              (m ||
                ...
                ((n.data = f.data),
                (n.handleObj = f),
                (s = ((K.event.special[f.origType] || {}).handle || f.handler)
                  .apply(u.elem, g)),
                s !== t &&
                  ((n.result = s),
      ...
      (K.event.special.submit = {
        setup: function() {
          return (
            ...
            void K.event.add(this, 'click._submit keypress._submit', function(
              e
            ) {
              var n = e.target,
                r =
      ...
      function i(e, i, o, a, s) {
        for (
          ...
          p
            ? ((f = f.concat(p)),
              (h = e.slice(c)) && ')' !== h
                ? M.test(h) ? n(h, f, o, a) : oe(h, i, o, a ? a.concat(p) : p)
                : T.apply(o, f))
            : oe(e, i, o, a);
        }
    ...
    K.extend({
      filter: function(e, t, n) {
        return (
          n && (e = ':not(' + e + ')'),
          1 === t.length
            ? K.find.matchesSelector(t[0], e) ? [t[0]] : []
            : K.find.matches(e, t)
        );
      },
      dir: function(e, n, r) {
        ...
        for (
          ...
          if ((t || K.acceptData(i)) && ((r = i[s]), (n = r && l[r]))) {
            ...
            l[r] &&
              ...
              u
                ? delete i[s]
                : i.removeAttribute ? i.removeAttribute(s) : (i[s] = null),
              K.deletedIds.push(r));
          }
      },
    }),
  ...
  K.ajaxSetup({
    ...
    K.ajaxPrefilter('json jsonp', function(n, r, i) {
      ...
      if ('jsonp' === n.dataTypes[0] || f || p)
        return (
          (o = n.jsonpCallback = K.isFunction(n.jsonpCallback)
            ? n.jsonpCallback()
            : n.jsonpCallback),
          (a = e[o]),
          f
  ...
  (K.fn.offset = function(e) {
    ...
    K.each({Height: 'height', Width: 'width'}, function(e, n) {
      K.each({padding: 'inner' + e, content: n, '': 'outer' + e}, function(
        r,
        i
      ) {
        K.fn[i] = function(i, o) {

    ...
    (n.AbstractEditor = t.extend({
      ...
      getHeaderText: function(t) {
        return this.header_text
          ? this.header_text
          : t ? this.schema.title : this.getTitle();
      },
        ...
        return (
          (t =
            'textarea' === this.input_type
              ? 6
              : ['text', 'email'].indexOf(this.input_type) >= 0 ? 4 : 2),
    ...
    (n.defaults.editors.array = n.AbstractEditor.extend({
      ...
      getItemSchema: function(t) {
        return Array.isArray(this.schema.items)
          ...
          : this.schema.items ? i({}, this.schema.items) : {};
      },
      ...
      typecast: function(t) {
        return 'boolean' === this.schema.type
          ...
          : 'number' === this.schema.type
            ? 1 * t
            : 'integer' === this.schema.type ? Math.floor(1 * t) : '' + t;
      },
      getValue: function() {
        return this.value;
      },
              ...
              if (
                ...
                if (
                  ...
                  for (e = 0; e < n.length; e++)
                    this.enumSource[r].filter({i: e, item: n[e], watched: t}) &&
                      o.push(n[e]);
                  n = o;
                }
                var a = [],
    ...
    (n.defaults.editors.multiselect = n.AbstractEditor.extend({
      ...
      sanitize: function(t) {
        return 'number' === this.schema.items.type
          ? 1 * t
          : 'integer' === this.schema.items.type ? Math.floor(1 * t) : '' + t;
      },
      enable: function() {
    ...
    return t.matches
      ...
      : t.webkitMatchesSelector
        ...
        : t.mozMatchesSelector
          ...
          : t.msMatchesSelector
            ? 'msMatchesSelector'
            : t.oMatchesSelector ? 'oMatchesSelector' : void 0;
  })();
